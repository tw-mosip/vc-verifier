...
import io.mosip.vercred.vcverifier.constants.CredentialVerifierConstants.RS256_ALGORITHM
...
class CredentialsVerifier {
    ...
    fun verifyCredentials(credentials: String?): Boolean {
        ...
        if (!CredentialVerifierConstants.SIGNATURE_SUITE_TERM.contains(ldProofTerm)) {
        ...
        return try {
            ...
            val publicKeyObj = getPublicKeyFromVerificationMethod(publicKeyJsonUri, PUBLIC_KEY_ALGORITHM.get(jwsHeader)!!)
            ...
            val signatureVerifier: SignatureVerifier = SIGNATURE_VERIFIER.get(jwsHeader)!!
